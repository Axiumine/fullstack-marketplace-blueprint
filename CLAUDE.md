...
| taking this blueprint past a workstation — the four shared secrets, their swap points, what a swap must not break | [`docs/PRODUCTION_HARDENING.md`](./docs/PRODUCTION_HARDENING.md) |
