...
| Phase 5 — Behaviour | ✅ Complete | **pass** | [`phase5/CONFLICT_REPORT.md`](./phase5/CONFLICT_REPORT.md) v1.2 | [`phase5/SEQUENCE_DIAGRAMS.md`](./phase5/SEQUENCE_DIAGRAMS.md), [`phase5/EPICS_STORIES.md`](./phase5/EPICS_STORIES.md), [`phase5/IDENTITY_ACCESS.md`](./phase5/IDENTITY_ACCESS.md), [`phase5/SESSION_TERMINATION.md`](./phase5/SESSION_TERMINATION.md) [`phase5/SHOPOWNER_ONBOARDING_APPROVAL.md`](./phase5/SHOPOWNER_ONBOARDING_APPROVAL.md), [`phase5/COMPANY_LEGAL_ENTITY.md`](./phase5/COMPANY_LEGAL_ENTITY.md) and [`phase5/CATALOGUE.md`](./phase5/CATALOGUE.md) (the E01..E05 records — the first two moved out of `epics/` on 2026-08-13, the other three on 2026-08-14), `phase5/epics/E06..E18.md`, [`phase5/RISK_REGISTER.md`](./phase5/RISK_REGISTER.md), [`phase5/DEFINITION_OF_DONE.md`](./phase5/DEFINITION_OF_DONE.md) |
