...
v1.5 — 2026-08-28: [`phase3/SECURITY_AUTH.md`](./phase3/SECURITY_AUTH.md) §3.6 was stale, still showing the pre-fix ungated `===`; it is corrected and now names, with file and line, the six sites that compare against `INTROSPECTION_CODE`. A seventh comparison site, upstream in `@axiumine/koa-utils` and beyond this platform's fixing, is recorded in [`../report/dependency-tree-advisory-scan.md`](../report/dependency-tree-advisory-scan.md) §6.1.
