...
| NFR-SE02 | Refresh token must travel as a Keygrip-signed httpOnly cookie | `Refresh token: Koa signed cookie (Keygrip SHA-512, KEYGRIP_KEY_1/2), httpOnly` — [`docs/architecture.md`](../../architecture.md) §Auth model |
