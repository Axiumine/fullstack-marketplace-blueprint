...
**R02 stays `Mitigated`, not `Closed`** (the KEK is still hand-provisioned per machine), and the residual row
opened at **R47**, R42 through R46 having been taken since the epic was written. E16-S09 ran the first
