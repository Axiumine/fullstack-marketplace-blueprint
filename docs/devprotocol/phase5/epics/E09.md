...
|---|---|---|
| `.githooks/pre-commit` + `.githooks/pre-push` in the 15 repos that carry both (14 sub-repos + parent; `marketplace-nginx` carries pre-push alone) | Any domain resolver's business logic | This context proves correctness, never implements a feature |
