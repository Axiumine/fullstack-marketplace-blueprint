...
| Item | In/Out | Why |
|---|---|---|
| `shopOwnerAdd` | In | the only way a `shopOwner` row is created |
...
**As an** Admin, **when** I submit a new shop owner's login and personal data, **I want** a `shopOwner` row
...
**As an** Admin, **when** I remove a shop owner, **I want** a `deleted` date stamped rather than the row
