...
Twenty-three of twenty-six stories are `built`. The two investigations ran on 2026-08-11 and closed; **they
...
live in `docker-DBs/docker-compose.yml`, and E12-S19 last, at the edge. **The 🔴 is closed**: no service with
a `DSN` set ships a request body any more. **Nothing from either investigation is open.** What remains is
three stories none of them opened: E12-S24, E12-S25 and the rest of E12-S26.
