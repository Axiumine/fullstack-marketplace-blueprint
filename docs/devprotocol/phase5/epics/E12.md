...
Nineteen of twenty-six stories are `built`. The two investigations ran on 2026-08-11 and closed; **they
found eight defects, E12-S16 … E12-S23, and four of the eight are now fixed** — E12-S16 first, once the
owner chose the mechanism, then E12-S21, E12-S22 and E12-S23 together, because they are one edit to the same
`Sentry.init` call in the same nine files. **The 🔴 is closed**: no service with a `DSN` set ships a request
body any more. A ninth, **E12-S24**, came out of checking E12-S22's "latent because no sample
...
| E12-S17 … E12-S20 | `not built` | Opened 2026-08-11 by the two investigations above. Each cites a measured observation rather than a reading, and each names the finding section it came from |
