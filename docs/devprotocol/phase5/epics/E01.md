...
- `BEs/marketplace-common/src/others/resolveAuthorizationSession.mts` (shared since `marketplace-common@4.4.0`)
...
- BC-03 (Shop Owner Onboarding & Approval) must create a `shopOwner` row and clear/hold `waitApprov`
