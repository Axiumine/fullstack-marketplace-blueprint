...
not shipped. CON-09's short name in §3 follows the same rewrite in `phase3/CONSTRAINTS.md`. Versions move
to `3.0.0` / `^3.0.0`. No constraint added, removed or weakened.
