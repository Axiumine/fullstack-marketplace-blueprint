...
stories live in `epics/ENN.md` and that stays true for E10..E19 — E02's record joined this one beside the
...
[`PLATFORM_OPERATIONS_QUALITY_GATES.md`](./PLATFORM_OPERATIONS_QUALITY_GATES.md)), all for the
same reason.
