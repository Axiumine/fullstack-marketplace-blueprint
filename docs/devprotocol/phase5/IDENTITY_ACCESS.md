...
stories live in `epics/ENN.md` and that stays true for E06..E18 — E02's record joined this one beside the
index later the same day ([`SESSION_TERMINATION.md`](./SESSION_TERMINATION.md)), and E03's, E04's and
E05's on 2026-08-14 ([`SHOPOWNER_ONBOARDING_APPROVAL.md`](./SHOPOWNER_ONBOARDING_APPROVAL.md),
[`COMPANY_LEGAL_ENTITY.md`](./COMPANY_LEGAL_ENTITY.md), [`CATALOGUE.md`](./CATALOGUE.md)), all for the
same reason.
