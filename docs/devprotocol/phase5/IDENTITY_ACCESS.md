...
stories live in `epics/ENN.md` and that stays true for E03..E18 — E02's record joined this one beside the
index later the same day ([`SESSION_TERMINATION.md`](./SESSION_TERMINATION.md)), for the same reason.
